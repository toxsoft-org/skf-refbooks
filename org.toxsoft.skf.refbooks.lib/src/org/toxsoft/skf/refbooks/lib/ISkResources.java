...
interface ISkResources {
  ...
  String STR_ABKIND_REFBOOKS                = Messages.getString( "STR_ABKIND_REFBOOKS" );                //$NON-NLS-1$
  String STR_ABKIND_REFBOOKS_D              = Messages.getString( "STR_ABKIND_REFBOOKS_D" );              //$NON-NLS-1$
  String STR_ABILITY_EDIT_REFBOOK_VALUES    = Messages.getString( "STR_ABILITY_EDIT_REFBOOK_VALUES" );    //$NON-NLS-1$
  String STR_ABILITY_EDIT_REFBOOKS_VALUE_D  = Messages.getString( "STR_ABILITY_EDIT_REFBOOKS_VALUE_D" );  //$NON-NLS-1$
  String STR_ABILITY_EDIT_REFBOOK_STRUCTS   = Messages.getString( "STR_ABILITY_EDIT_REFBOOK_STRUCTS" );   //$NON-NLS-1$
  String STR_ABILITY_EDIT_REFBOOK_STRUCTS_D = Messages.getString( "STR_ABILITY_EDIT_REFBOOK_STRUCTS_D" ); //$NON-NLS-1$

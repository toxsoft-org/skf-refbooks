...
interface ICodegenPackageConstants {
  ...
  IDataDef OPDEF_GW_IS_ITEMS_INCLUDED = DataDef.create( "GwIsItemsIncluded", BOOLEAN, //$NON-NLS-1$
      TSID_NAME, STR_OPDEF_GW_IS_ITEMS_INCLUDED, //
      TSID_DESCRIPTION, STR_OPDEF_GW_IS_ITEMS_INCLUDED_D, //

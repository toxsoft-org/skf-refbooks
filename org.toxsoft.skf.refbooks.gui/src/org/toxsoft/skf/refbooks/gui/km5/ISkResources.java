...
public interface ISkResources {
   ...
   */
  String STR_ABILITY_ACCESS_REFBOOK_EDITOR   = Messages.getString( "STR_ABILITY_ACCESS_REFBOOK_EDITOR" );   //$NON-NLS-1$
  String STR_ABILITY_ACCESS_REFBOOK_EDITOR_D = Messages.getString( "STR_ABILITY_ACCESS_REFBOOK_EDITOR_D" ); //$NON-NLS-1$

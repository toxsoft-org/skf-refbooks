...
/**
 * {@link IM5EntityPanel} implementation to be returned by {@link RbedDtoRefbookInfoM5Model}.
 * <p>
 * Entity panel contains:
 * <ul>
 * <li>top part - ladder layout field editors for fields class ID, parent ID, name and description;</li>
 * <li>bottom part - tab folder with separate tab for class properties like: attr, links, clobs, etc.</li>
 * </ul>
 *
 * @author dima
 */
public class RbedDtoRefbookInfoM5EntityPanel
    extends M5DefaultEntityEditorPanel<IDtoRefbookInfo> {
   ...
   */
  public RbedDtoRefbookInfoM5EntityPanel( ITsGuiContext aContext, IM5Model<IDtoRefbookInfo> aModel,
